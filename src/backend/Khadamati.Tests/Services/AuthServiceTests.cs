...
public class AuthServiceTests : IDisposable
{
    ...
    public AuthServiceTests()
    {
        ...
        var config = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["Jwt:RememberMeRefreshTokenExpirationDays"] = "30",
                ["Auth:EmailVerificationExpirationHours"] = "24",
                ["Auth:PasswordResetExpirationHours"] = "1",
                ["Auth:OtpExpirationMinutes"] = "10",
                ["Auth:MaxOtpAttempts"] = "5",
                ["Auth:MaxOtpRequestsPerHour"] = "5"
            })
            .Build();
        ...
        _authService = new AuthService(
            _context, unitOfWork, authRepository, tokenService, _passwordHasher,
            emailMock.Object, otpService, smsMock.Object, mapper, config, logger.Object);
    }

    [Fact]
    public async Task Register_ShouldCreateUserAndReturnTokens()
    {
        var request = new RegisterRequestDto("newuser@test.com", "+966509999999", "Password1!", "Test", "User", "Customer");
    ...
    public async Task ChangePassword_ShouldUpdateHash()
    {
        ...
        await _authService.ChangePasswordAsync(user.Id, new ChangePasswordRequestDto("OldPass1!", "NewPass1!", "NewPass1!"));
