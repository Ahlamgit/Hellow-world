...
public interface IPaymentWebhookService
{
    ...
    Task<PaymentWebhookResultDto> ProcessAreebaWebhookAsync(AreebaWebhookDto payload, string? signature, string rawBody, CancellationToken cancellationToken = default);
}
