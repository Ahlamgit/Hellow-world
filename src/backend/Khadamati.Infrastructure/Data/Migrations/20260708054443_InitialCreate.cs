        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceRadiusKm = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StoreProfiles_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CraftsmanServices_CraftsmanProfiles_CraftsmanProfileId",
                        column: x => x.CraftsmanProfileId,
                        principalTable: "CraftsmanProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CraftsmanServices_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StoreProducts_StoreProfiles_StoreProfileId",
                        column: x => x.StoreProfileId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CraftsmanServices_CraftsmanProfileId_ServiceId",
                table: "CraftsmanServices",
                columns: new[] { "CraftsmanProfileId", "ServiceId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CraftsmanServices_ServiceId",
                table: "CraftsmanServices",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_CraftsmanId",
                table: "ServiceRequests",
                column: "CraftsmanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoreProducts_StoreProfileId",
                table: "StoreProducts",
                column: "StoreProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_StoreProfiles_UserId",
                table: "StoreProfiles",
                column: "UserId",
                unique: true);
