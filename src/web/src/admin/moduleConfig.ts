...
export const ADMIN_MODULES: ModuleConfig[] = [
  { key: 'users', title: 'Users', titleAr: 'المستخدمون', columns: [{ key: 'email', label: 'Email', sortable: true }, { key: 'phone', label: 'Phone' }, { key: 'role', label: 'Role' }, { key: 'status', label: 'Status' }, { key: 'createdAt', label: 'Created' }], bulkActions: ['activate', 'deactivate', 'suspend', 'delete'], filters: [{ key: 'status', label: 'Status', options: ['Active', 'Pending', 'Suspended', 'Banned'] }, { key: 'role', label: 'Role', options: ['SuperAdmin', 'Admin', 'SupportAgent', 'Moderator', 'Customer', 'Craftsman', 'StoreOwner', 'StoreEmployee', 'Accountant'] }] },
  ...
  { key: 'verification-documents', title: 'Verification', titleAr: 'التحقق', columns: [{ key: 'userEmail', label: 'User' }, { key: 'documentType', label: 'Type' }, { key: 'status', label: 'Status' }, { key: 'createdAt', label: 'Submitted' }] },
  ...
  { key: 'backup', title: 'Backup', titleAr: 'النسخ الاحتياطي', columns: [{ key: 'name', label: 'Name' }, { key: 'status', label: 'Status' }, { key: 'sizeBytes', label: 'Size' }, { key: 'filePath', label: 'File' }, { key: 'createdAt', label: 'Created' }] },
