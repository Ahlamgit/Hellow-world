...
**Governance:** [`../governance/FINANCE_POLICY_APPROVAL_MATRIX.md`](../governance/FINANCE_POLICY_APPROVAL_MATRIX.md) — ownership & approval · [`../governance/FINANCE_POLICY_LIFECYCLE.md`](../governance/FINANCE_POLICY_LIFECYCLE.md) — versioning, change workflow, audit
