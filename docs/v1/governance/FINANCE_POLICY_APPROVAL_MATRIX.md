...
**Sources:**  
[`../config/FINANCE_LEBANON_INITIAL_CONFIGURATION.md`](../config/FINANCE_LEBANON_INITIAL_CONFIGURATION.md) · ADR-013 · ADR-026 · [`STAKEHOLDER_SIGN_OFF_PACKAGE.md`](./STAKEHOLDER_SIGN_OFF_PACKAGE.md)
