...
**Finance Lebanon config:** [config/FINANCE_LEBANON_INITIAL_CONFIGURATION.md](./config/FINANCE_LEBANON_INITIAL_CONFIGURATION.md) · [governance/FINANCE_POLICY_APPROVAL_MATRIX.md](./governance/FINANCE_POLICY_APPROVAL_MATRIX.md) — BLOCKER-005 **IN PREPARATION**  
