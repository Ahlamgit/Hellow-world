...
- **Readiness Blocker Closure pack published** — checklists/templates/plans for all blockers; **0/7 closed**  
  ...
  - BLOCKER-005: **IN PREPARATION** — [`config/FINANCE_LEBANON_INITIAL_CONFIGURATION.md`](./config/FINANCE_LEBANON_INITIAL_CONFIGURATION.md) (values Pending Business Decision; not COMPLETED)  
...
| BLOCKER-005 | G-05 | Finance Lebanon config | [`config/FINANCE_LEBANON_INITIAL_CONFIGURATION.md`](./config/FINANCE_LEBANON_INITIAL_CONFIGURATION.md) | **IN PREPARATION** |
...
| G-05 | **Finance** Lebanon config **IN PREPARATION** — structure ready; values Pending Business Decision | Finance | Critical for money |
