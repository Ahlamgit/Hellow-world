...
- **Readiness Blocker Closure pack published** — checklists/templates/plans for all blockers; **0/7 closed**  
  ...
  - BLOCKER-004: **IN PREPARATION** — Cloud Decision + [`infra/CLOUD_SIZING_AND_COST_FRAMEWORK.md`](./infra/CLOUD_SIZING_AND_COST_FRAMEWORK.md) (provider/budget/workload Pending; not COMPLETED)  
...
| BLOCKER-004 | G-04 | Cloud infrastructure | [`infra/CLOUD_INFRASTRUCTURE_DECISION.md`](./infra/CLOUD_INFRASTRUCTURE_DECISION.md) · [`infra/CLOUD_SIZING_AND_COST_FRAMEWORK.md`](./infra/CLOUD_SIZING_AND_COST_FRAMEWORK.md) | **IN PREPARATION** |
...
| G-04 | **Cloud** **IN PREPARATION** — blueprint + sizing/cost framework ready; provider/budget/RPO/RTO Pending | DevOps/Business | Critical |
