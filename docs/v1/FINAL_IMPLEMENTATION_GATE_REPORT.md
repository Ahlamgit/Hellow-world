...
- **Readiness Blocker Closure pack published** — checklists/templates/plans for all blockers; **0/7 closed**  
  ...
  - BLOCKER-004: **IN PREPARATION** — [`infra/CLOUD_INFRASTRUCTURE_DECISION.md`](./infra/CLOUD_INFRASTRUCTURE_DECISION.md) (selections Pending; not COMPLETED)  
...
| BLOCKER-004 | G-04 | Cloud infrastructure | [`infra/CLOUD_INFRASTRUCTURE_DECISION.md`](./infra/CLOUD_INFRASTRUCTURE_DECISION.md) | **IN PREPARATION** |
...
| G-04 | **Cloud** **IN PREPARATION** — vendor-neutral blueprint ready; provider/hosting/RPO/RTO Pending Infrastructure Approval | DevOps/Business | Critical |
